...
public class Tester {
    public static void main(String[] args) {
        ...
        System.out.println("Jønkes gadenavn: " + p1.getAddress().getStreet());
        
        System.out.println("Lad os se om to-vejs virker: " + a1.getPerson().getName());
        
        System.out.println("Hvem har betalt f1? Det har: " + f2.getPerson().getName());
        ...
        for (Fee f : fees) {
            System.out.println(f.getPerson().getName() + ": " + f.getAmount() + ", " + f.getPayDate() + " Addr: " + f.getPerson().getAddress().getCity());
        }
        ...
        //Create JPQL with constructor projection
